      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="space-y-4">
            <h3 className="text-3xl font-serif tracking-tight text-gold-400">MANASOR</h3>
            <p className="text-olive-100 text-sm leading-relaxed">
              Gemlik'in bereketli topraklarından sofralarınıza uzanan doğal bir lezzet yolculuğu. Geleneksel yöntemlerle, doğaya saygıyla üretiyoruz.
            </p>
            <div className="flex space-x-4 pt-2">
              <a href="#" className="text-olive-100 hover:text-gold-400 transition-colors">
          ...
          {/* Kurumsal */}
          <div>
            <h4 className="text-lg font-medium text-white mb-4">Kurumsal</h4>
            <ul className="space-y-2 text-sm text-olive-100">
              <li><Link href="/terms" className="hover:text-gold-400 transition-colors">Mesafeli Satış Sözleşmesi</Link></li>
          ...
          {/* İletişim */}
          <div>
            <h4 className="text-lg font-medium text-white mb-4">İletişim</h4>
            <ul className="space-y-4 text-sm text-olive-100">
              ...
              <li className="flex items-center space-x-3">
                ...
                <span>+90 (224) 513 00 00</span>
              </li>
              <li className="flex items-center space-x-3">
                <Mail className="w-5 h-5 text-gold-400 flex-shrink-0" />
                <span>info@manasor.com</span>
              </li>
            </ul>
          </div>
        </div>
